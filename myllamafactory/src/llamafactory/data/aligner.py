...
def convert_alpaca(
    ...
    """
    outputs = {"prompt": [], "response": [], "system": [], "p_system": [], "n_system": [], "raw":[], "tools": [], "images": []}
    ...
    for i in range(len(examples[dataset_attr.prompt])):
        ...
        if dataset_attr.kto_tag and isinstance(examples[dataset_attr.kto_tag][i], bool):  # kto example
            ...
            and dataset_attr.chosen
            and dataset_attr.rejected
        ...
        raw = [{"role": Role.ASSISTANT.value, "content": examples[dataset_attr.raw][i]}]

        outputs["prompt"].append(prompt)
        outputs["system"].append(examples[dataset_attr.system][i] if dataset_attr.system else "")
        outputs["p_system"].append(examples[dataset_attr.p_system][i] if dataset_attr.p_system else "")
        outputs["n_system"].append(examples[dataset_attr.n_system][i] if dataset_attr.n_system else "")
...
def align_dataset(
    ...
    Aligned dataset:
        ...
        tools: "...",
        images: [],
    return "prompt", "system", "p_system", "n_system", "response", "tools", "images"
    """
    ...
    features = Features.from_dict(
        {
            ...
            "p_system": {"dtype": "string", "_type": "Value"},
            "n_system": {"dtype": "string", "_type": "Value"},
