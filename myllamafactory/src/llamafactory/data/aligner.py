...
def convert_sso(
    ...
    if dataset_attr.kto_tag and isinstance(example[dataset_attr.kto_tag], bool):  # kto example
        ...
        and isinstance(example[dataset_attr.raw], str)
        ...
        response = [
            ...
            {"role": Role.ASSISTANT.value, "content": example[dataset_attr.raw]},
        ]
    ...
    output = {
        ...
        "_p_system": example[dataset_attr.p_system] if dataset_attr.p_system else "",
        "_n_system": example[dataset_attr.n_system] if dataset_attr.n_system else "",
...
def align_dataset(
    ...
    if dataset_attr.formatting == "sso":
        convert_func = partial(convert_sso, dataset_attr=dataset_attr, data_args=data_args)
